...
$post_array["search"]=$_REQUEST['s'];
 ...
 $apicallpath=  get_option('btc_apipath').RECEIVETRANSACTION;
$returndata = $api->getSocialUserAuthentication($post_array,$apicallpath);
//echo "<pre>";
//print_r($returndata);
$total = $returndata['data'][0]['totalreceive'];
$num_of_pages = ceil($total / $limit);
$entries = $returndata['data'][0]['receivelist'];
        ...
        <table class="wp-list-table widefat fixed pages">
            ...
            if($num_of_pages > 0)
            {
                ...
                <tr <?php if($i%2!=0){?>class="alternate"<?php }?>>
                    ...
                    <td style="color: #0074a2 !important;"><?php echo $result['bitcoin_address']; ?></td>
